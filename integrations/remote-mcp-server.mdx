...
Once connected, MemoryPlugin exposes the same capabilities as the [local MCP server](/integrations/mcp-server), plus some extras:
...
Refer to the [MCP Server](/integrations/mcp-server#available-tools) page for the full tool list.
