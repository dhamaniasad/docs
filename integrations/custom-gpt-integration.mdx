...
# Integrate MemoryPlugin into Your Own Custom GPT
...
5. Enter your token (keep it confidential!)
...
In the **Instructions** section of the Configure tab, add the MemoryPlugin instructions after your existing custom instructions:
