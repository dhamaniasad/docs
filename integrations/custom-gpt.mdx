...
<Warning>
Custom GPTs only support GPT-4o and do not let you switch models. If you want to use other models, the [browser extension](/integrations/browser-extension) is a better choice.
</Warning>
...
3. Once selected, all messages will be processed by GPT-4o instead of your chosen model
...
- **Search memories**: Find relevant information from your stored memories
- **Organize**: The GPT can help organize and categorize your memories
