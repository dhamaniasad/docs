...
| **Browser Extension** | Best overall experience | 2 minutes | 21+ platforms (desktop & mobile) |
| **Desktop App (Mac)** | Syncing Claude Code, Codex & Cursor chats | 2 minutes | macOS |
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="desktop"
    href="/integrations/desktop-app"
  >
    **For coding chats** - Claude Code, Codex, Cursor

    Perfect if you:
    - Chat with coding agents on your Mac
    - Want those chats in your searchable history
    - Want a global chat search shortcut (⌘⇧K)
  </Card>
...
<Frame caption="The browser extension panel, showing your buckets and memories right alongside the AI you are chatting with.">
  <img className="block dark:hidden" src="/images/screenshots/extension/panel-v4.png" alt="The MemoryPlugin browser extension panel open next to an AI chat" />
  <img className="hidden dark:block" src="/images/screenshots/extension/panel-v4-dark.png" alt="The MemoryPlugin browser extension panel open next to an AI chat" />
</Frame>

<Tabs>
  <Tab title="Pros">
    - Rich visual interface with bucket switching
    - Works with 21+ AI platforms
    ...
    - Chat history sync for ChatGPT, Claude, Gemini, Grok, DeepSeek, and TypingMind
...
<Tabs>
  <Tab title="Pros">
    ...
    - Once configured, runs without further clicks
  </Tab>
  <Tab title="Cons">
    - No visual UI
...
<AccordionGroup>
  ...
  <Accordion title="Can I combine them?" icon="circle-plus">
    Yes, and on Claude it is the recommended setup: the **remote MCP server** lets Claude call your memory tools itself, and the **browser extension** keeps your chats syncing into chat history. The integrations share one memory, so mixing them never creates duplicates. Remember that ongoing chat history sync always needs the extension, whichever integration you read memories through.
  </Accordion>
