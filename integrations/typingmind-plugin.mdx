...
<Steps>
  <Step title="Get Plugin Link">
    In your MemoryPlugin dashboard, click **Connect** in the sidebar, then **Add a tool**, and pick TypingMind to get the plugin link
  </Step>
  <Step title="One-Click Install">
    Click **Get the plugin** - this opens the MemoryPlugin plugin in TypingMind so you can install it
  </Step>
  <Step title="Configure Authentication">
    Enter your MemoryPlugin Auth Token in the plugin settings. Copy it from **Connect → Access** in the dashboard: [memoryplugin.com/dashboard/connect?tab=access](https://memoryplugin.com/dashboard/connect?tab=access)
  </Step>
