...
- **A native app**: Ask, search across your whole chat history, a conversation reader with a scrubbable timeline, and full memory management (buckets, Smart Memory categories, Suggestions).
