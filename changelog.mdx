...
<Update label="August 2026" description="Native iPhone App, Claude's New Export Format, Import Emails, ChatGPT Capture Fix" tags={["Features", "Improvements"]}>
  ### A native iPhone app
  The iOS app used to be a thin shell around the Safari extension. It's now a real app:

  - **Ask, on your phone** - question your memories and chat history from anywhere, with answers that stream in as they're written and live status while it searches.
  ...
  - **Your memories, natively** - browse buckets, add, edit, move, and delete memories with standard iOS flows, review Smart Memory categories, and work through cleanup Suggestions.
