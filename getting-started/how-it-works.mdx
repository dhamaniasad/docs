...
<Tabs>
  ...
  <Tab title="Custom GPT">
    Uses function/tool calls to store memories directly
  </Tab>
  <Tab title="MCP Server">
    Similar to Custom GPT, uses equivalent tool calls for memory storage
  </Tab>
</Tabs>

<Note>
All processing happens on your device, and only the specifically formatted memory text is sent to our servers.
</Note>
