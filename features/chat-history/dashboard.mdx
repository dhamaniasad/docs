...
<Frame caption="Starting a new import: pick the export source, choose how many chats to import, and drop in your JSON export.">
  <img src="/images/screenshots/chat-history/import-modal.png" alt="New Import modal with a warning banner, an Export source selector (ChatGPT, Claude, TypingMind), chat-count presets, and a JSON drag-and-drop zone" />
</Frame>
