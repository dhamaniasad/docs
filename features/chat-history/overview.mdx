...
### Upload Chat Exports
Export your chat history as JSON files from ChatGPT, Claude, or TypingMind and upload them to MemoryPlugin. Processing happens automatically in the background.

### Online Import (Beta)
For ChatGPT and Claude, we can import your conversations directly from your account without needing to download files. This is currently in beta.

Once imported, your chat history becomes searchable and automatically injects relevant context into new conversations via our Browser Extension or MCP Server.

## Get Started

<CardGroup cols={2}>
  <Card
    title="Upload & Manage Chat History"
    icon="cloud-arrow-up"
    href="/features/chat-history/dashboard"
  >
    Learn how to import your chats, manage your quota, and use the dashboard features
  </Card>
  <Card
    title="Browser Extension & MCP"
    icon="puzzle-piece"
    href="/features/chat-history/integration"
  >
    Set up auto-injection of chat history context into new conversations
  </Card>
  <Card
